...
Gibberish.Follow = function() {
  ...
  Object.defineProperty( this, 'value', {
    configurable: true,
    get: function() { return value },
    set: function(v) { value = v; /* not sure why this would ever happen, but... */ },
  })
      ...
      if(isRunning) {
        if(phase >= nextTime) {
          ...
          if(Array.isArray(that.durations)) {
						var durationsIndex = typeof that.durations.pick === 'function' ? that.durations.pick() : that.durationsIndex++,
                next = that.durations[ durationsIndex ];
								
            that.nextTime = typeof next === 'function' ? next() : next;
						
						if( that.chose ) that.chose( 'durations', durationsIndex )
