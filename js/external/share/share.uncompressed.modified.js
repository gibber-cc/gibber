  ...
  */
  ...
  ReconnectingWebSocket = (function() {
    function ReconnectingWebSocket(url, protocols, Socket) {
      ...
      connect = function(reconnectAttempt) {
        var timeout;
        console.log( "Bchannel URL:",_this.url)
        try {
  ...
  Connection = (function() {
    function Connection(host, authentication) {
      var _this = this;
      host = 'http://gibber.mat.ucsb.edu/channel'
      console.log('NEW CONNECTION:', host )
      this.docs = {};
      ...
      this.socket = (function() {
        switch (socketImpl) {
          case 'channel':
            console.log( BCSocket )
            return new window.BCSocket(host, {
              reconnect: true
            });
          case 'sockjs':
