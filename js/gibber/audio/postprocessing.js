( function() {
  ...
  window.LowShelf = Gibber.AudioPostProcessing.LowShelf
  window.HiShelf = Gibber.AudioPostProcessing.HiShelf  
  window.Compressor = Gibber.AudioPostProcessing.Compressor
})()