  ...
  Keymap : {
	...
	modes : {
		...
		javascript : {
			...
			default: [
      "// set maximum number of measures that can be specified for timing",
      "// anything higher than this is measured as samples",
      "Gibber.Clock.maxMeasures = 44",
      "",
      "// create beat with electronic drums",
      "a = XOX('x*o*x*o-')",
      "a.snare.snappy = 1.5;",
      "",
      "// record drums output for two measures",
      "c = Sampler().record( a, 2);",
      "c.amp = .5",
      "",
      "// play back recorded drums at different speeds",
      "d = Seq({",
